...
from ...common import setTextColor
...
class ToastInfoBar(QFrame):
    ...
    def custom(
        ...
        cls.new(parent, title, content, duration, isClosable, position, QColor(toastColor), isCustomBgcColor, bgcColor)
